...
<p class="article-paragraph">
  T-Rexの強さのシンボルといえば、何といっても他の肉食恐竜をはるかにしのぐ圧倒的な「噛む力」です。近年のコンピューターを使った最新の研究によると、大人のT-Rexが噛む力は、最大で約3.5トンから5.8トンもあったと計算されています。これは、現代のワニの約3〜4倍、ライオンの約15倍、そして私たち人間の約60倍以上という、ケタ違い of 強さです。
</p>
<p class="article-paragraph">
