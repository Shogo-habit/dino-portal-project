...
<p class="article-paragraph">
  恐竜たちの歴史は、地球環境の劇的な変化に適応し続けた進化のストーリーです。時代の名前とそれぞれの環境を知ることで、目の前にある化石が「どのような世界で暮らしていたのか」をより深くリアルに感じ取ることができるようになります。
    ...
    date: "2026.06.03",
    category: "RESEARCH",
    title: "【最強の肉食恐竜】ティラノサウルスのすべてを徹底解説！強大な顎と驚異の五感の秘密",
...
<p class="article-paragraph">
  大昔の地球にいた恐竜たちの中で、最も人気があるのはどの恐竜でしょうか。多くの人は、するどい牙と強靭な体を持つ肉食恐竜「ティラノサウルス」を思い浮かべるでしょう。<br />
  そして、そのティラノサウルスと肩を並べるほどの圧倒的な人気を誇るのが、頭に3本の角と大きな襟飾り（フリル）を持つ植物食恐竜「トリケラトプス」です。
</p>
<p class="article-paragraph">
  トリケラトプスは、恐竜時代の最後にあたる「白亜紀」の終わり頃、現在の北アメリカ大陸に生息していました。<br />
  この時代は恐竜たちの進化が最も進んだ完成期であり、彼らはその生態系の主役でした。<br />
  実は、化石の発見される数が他の恐竜に比べて非常に多く、当時の森や湿地にはたくさんのトリケラトプスが群れをなして暮らしていたと考えられています。<br />
  まさに、ティラノサウルスが「陸の王様」なら、トリケラトプスは「大地を支えた緑の主役」と呼ぶにふさわしい、白亜紀を代表する大スターなのです。
</p>
...
<div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap; margin-bottom: 20px;">
  <div style="flex: 1; min-width: 280px;">
    ...
    <p class="article-paragraph">
      まず、その大きさですが、大人のトリケラトプスは全長が約8〜9メートル、体重は5〜9トンもあったと推定されています。<br />
      これは、現代の陸上で一番大きな動物であるアフリカゾウと同じか、それ以上の重さです。<br />
      体はどっしりとした低重心で、まるで頑丈な戦車のようでした。<br />
      4本の足は非常に太く、筋肉がしっかりとついており、この巨大な体重をしっかりと支えていました。
    </p>
    <p class="article-paragraph">
      彼らの主な食べ物は、地面近くに生えていたシダ植物や、ソテツなどの硬い葉っぱでした。<br />
      トリケラトプスの口先は、オウムのようなくちばしの形をしており、これで硬い植物の茎をスパッと切り取っていました。
    </p>
    <p class="article-paragraph" style="margin-bottom: 0;">
      そして、彼らの口の奥には、植物を食べるための驚くべき仕組みが隠されていました。<br />
      それは、何百本もの小さな歯がすき間なくびっしりと並び、まるで大きなすり鉢のようになった「歯の板」です。<br />
      この仕組みのおかげで、彼らは硬い繊維質の植物を細かくすりつぶして消化することができました。<br />
      さらに、歯がすり減って使えなくなると、下から新しい歯が次々と押し出されて生え変わるようになっていました。<br />
      生涯にわたって常に新しく鋭い歯を維持し続けることができたこの仕組みこそが、トリケラトプスが大繁栄できた大きな秘密だったのです。
    </p>
  </div>
