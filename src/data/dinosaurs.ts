export const DINOSAURS = [
  ...
  },
  {
    ...
    name: "スーパーサウルス",
    kana: "すーぱーさうるす",
    scientificName: "Supersaurus vivianae",
    era: "ジュラ紀後期",
    region: "北アメリカ",
    diet: "草食",
    length: "39.0m",
    ...
    bioTraits: [
      { trait: "全長", value: "史上最長クラス", detail: "40mに迫る極めて長い首と尾" },
      { trait: "防御", value: "巨大な尾", detail: "細長い尾を鞭のように使って外敵を撃退した" }
    ],
  ...
  },
  {
    ...
    bioTraits: [
      { trait: "首の長さ", value: "特異的", detail: "剣竜類の中で最も長い首を持つ" },
      { trait: "骨板", value: "小型", detail: "首から背中にかけて小さな骨板とスパイクが並ぶ" }
    ],
